...
const config: Config = {
  ...
  tagline: 'Building the Bodies for Artificial Minds',
  ...
  url: 'https://physical-ai-coursework.example.com',
  baseUrl: '/',

  organizationName: 'physical-ai-course', // Usually your GitHub org/user name.
  projectName: 'physical-ai-coursework', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://docs.ros.org/en/humble/', // Changed to external link to fix broken link
          label: 'API',
          position: 'left',
        },
        {
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'Curriculum',
              to: '/docs/intro/preamble', // Fixed link
            },
          ],
        },
        {
