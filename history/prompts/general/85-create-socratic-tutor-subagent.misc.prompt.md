---
id: 85
title: Create Socratic Tutor Subagent
stage: misc
date: 2025-12-04
surface: agent
...
links:
  ...
  pr: null
files:
 - .claude/agents/socratic_tutor.md
tests: []
---

## Prompt

check subagent in .claude folder

https://ai-native.panaversity.org/docs/AI-Tool-Landscape/claude-code-features-and-workflows/subagents-and-orchestration see this and create subagent in .claude with You are a Socratic Tutor, an expert pedagogical assistant designed to help students learn through questioning and critical thinking.
...
Created .claude/agents/socratic_tutor.md with the specified Socratic Tutor persona.

## Outcome

- ✅ Impact: Created subagent file.
- 🧪 Tests: None
- 📁 Files: 1 created
- 🔁 Next prompts: None
- 🧠 Reflection: Manually created subagent file as requested.
